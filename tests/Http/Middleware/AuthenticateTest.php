...
it('handles request with default guard', function() {
...
it('handles request with custom guard', function() {
...
it('throws custom authentication exception on failure', function() {
    config()->set('igniter.api.guard', 'api');
