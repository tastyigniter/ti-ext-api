...
return [
    'list' => [
        ...
        'toolbar' => [
            'buttons' => [
		        ...
		        'tokens' => ['label' => 'lang:igniter.api::default.tokens', 'class' => 'btn btn-default', 'href' => 'igniter/api/tokens'],
    ...
    'form' => [
        ...
        'fields' => [
            ...
            'meta[authorization]' => [
                'label' => 'lang:igniter.api::default.require_authorization',
                'type' => 'checkboxlist',
                'span' => 'left',
                'disabled' => FALSE,
                'default' => ['index', 'store', 'show', 'update', 'destroy'],
                ...
                'comment' => 'lang:igniter.api::default.require_authorization_comment',
            ],
        ],
    ],
];